...
class LeftEyeCam(object):
    ...
    def __init__(self) -> None:
        ...
        self.left_eye_sub = rospy.Subscriber("/left_eye/image_raw", Image, self.eye_img_callback)
...
if __name__ == '__main__':
    rospy.init_node('display_left_eye')
    left_eye_cam = LeftEyeCam()
    rospy.spin()