...
## Main Function
def main(motor_id, sequence, trials):
    max_amplitude = sequence[0]
    ...
    int_motor_list, deg_motor_list = generate_sequence(sequence)
    ...
    title_str = dt_str + '_PIDSweepTop1_' + motor_name + '_' + '%damp_'%(max_amplitude)
    pickle_data = {
        "title": title_str,
        "datetime": dt_str,
        "data_list": [],
...
if __name__ == "__main__":
    sequence = list(range(60,0,-5))
    trials = 10
    main(motor_id=14, sequence=sequence, trials=trials)